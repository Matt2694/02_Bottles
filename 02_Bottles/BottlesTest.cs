...
namespace _02_Bottles
{
    ...
    public class BottlesTest
    {
        ...
        [TestMethod]
        public void CountDownFromFour()
        {
            //Song song = new Song();
            Assert.AreEqual("4 bottles of beer on the wall. 4 bottles of beer. "
                ...
                + " 1 bottle of beer."
                + " Take one down and pass it around."
                + " No more bottles of beer on the wall.", song.CountBottles(4));
        }
        [TestMethod]
        public void CountDownFromFive()
        {
            //Song song = new Song();
            Assert.AreEqual("5 bottles of beer on the wall. 5 bottles of beer. "
